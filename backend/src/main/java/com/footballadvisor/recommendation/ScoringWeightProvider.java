...
public class ScoringWeightProvider {
    ...
    public double getMinimumBudgetMatchForRecommendation() {
        return readWeight("hasMinimumBudgetMatchForRecommendation");
    }

    public double getMinimumAgeMatchForRecommendation() {
